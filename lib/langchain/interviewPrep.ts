 ...
 * @param company The company name (can be generic if unknown).
 * @param role The job role (can be generic if unknown).
 * @param interviewType The type of interview (e.g., 'technical', 'behavioral', 'mixed').
...
export const generateInterviewQuestions = async (
  ...
  try {
    ...
    // Create a more flexible prompt that works with generic info
    const promptTemplate = PromptTemplate.fromTemplate(`
      ...
      - Technical: "How would you approach..." or "What's your experience with..."
      - Company-specific: "Why are you interested in this role/company?"
    `);
    ...
    // Ensure we have at least some questions, even if AI fails
    ...
    // Provide fallback questions instead of throwing error
...
function getFallbackQuestions(role: string, interviewType: string): Question[] {
  ...
  // Add technical question if role seems technical
