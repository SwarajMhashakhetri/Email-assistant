 ...
 * @returns {Promise<object>} A promise that resolves to a structured object with extracted tasks.
 */
export const emailAnalysisChain = async (emailContent) => {
  // 1. Define the LLM
        ...
        tasks: {
          ...
          items: {
            ...
            properties: {
              ...
              task_type: { type: "string", enum: ["interview", "meeting", "assignment", "general"], description: "The type of task." },
              ...
              links: { type: "array", items: { type: "string" }, description: "Any relevant URLs found in the email." },
            },
  ...
  console.log("Analyzing email with LangChain...");
  return await chain.invoke({ email_content: emailContent });
};